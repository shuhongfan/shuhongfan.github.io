...
- path.parse：把路径转换为对象
  ...
  - name：不包含后缀名的文件名
- path.join：拼接路径
- path.isAbsolute：判断一个路径是否为绝对路径[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-Ealv3v9t-1604973760855)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200315150610001.png)]
...
- `__dirname`和`filename`是不受执行node命令所属路径影响的
  ...
  [外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-uR8w8JIs-1604973760861)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200315151551873.png)]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-ON3hQ3G8-1604973760863)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200314144807008.png)]为了解决以上编码方式带来的问题（回调地狱嵌套），所以在EcmaScript6新增了一个API:`Promise`。[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-1VgyekSz-1604973760866)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200314150050839.png)]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-6GrJxOPz-1604973760869)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200315100611620.png)]

链式循环：[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-SrXheEVz-1604973760870)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200315125559136.png)]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-QOh98esc-1604973760872)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200314094620191.png)]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-SJu9kN0M-1604973760874)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200316202757617.png)]
...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-XwREU66N-1604973760875)(C:\Users\A\AppData\Roaming\Typora\typora-user-images\image-20200317110520098.png)]
